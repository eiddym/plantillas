(function() {
  ...
  angular
  .module('app')
  .service('DataService', ['$http', '$q', 'Message', 'Util', '$sce', '$log', DataService]);



  /** @ngInject */
  function DataService($http, $q, Message, Util, $sce, $log) {
    ...
    function save(url, data) {
      ...
      .then(function (response) {
        ...
        return $q.reject({
          status: 0,
          message: 'El servidor no devolvió datos al guardar.'
        });
      }).catch(function (error) {
        msgError(error);
