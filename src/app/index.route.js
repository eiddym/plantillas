(function() {
  ...
  function routerConfig($stateProvider, $urlRouterProvider) {
    $stateProvider
      ...
      // --- INICIO DE NUEVA RUTA DE UNIDADES ---
      .state('unidad', {
        url: '/unidad',
        templateUrl: 'app/modules/admin/unidades/unidad.html',
        controller: 'UnidadController',
        controllerAs: 'vm'
      })
      // --- FIN DE NUEVA RUTA DE UNIDADES ---
      .state('menu', {
        url: '/menu',
      ...
      .state('aprobarDocumento', {
        url: '/aprobar_documento',
        templateUrl: 'app/modules/plantillasFormly/aprobarDocumento/modules.plantillasFormly.aprobarDocumento.html',
        controller: 'AprobarDocumentoController',
        controllerAs: 'aprobarDocumento'
      })
      .state('vistaPdf', {
        url: '/vista_pdf',
